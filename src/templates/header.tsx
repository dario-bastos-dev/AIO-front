...
const Header: React.FC<HeaderLinkProps> = ({ match }) => {
	return (
		<header>
			<nav className="flex justify-between bg-[#000]/20 backdrop-blur-[10px] text-white p-6 fixed w-full z-50 text-2xl">
				<span className="gap-2 flex font-bold">
					AIO
					<span className="font-light">ALL IN ONE</span>
				</span>

				<div className="flex itens-center gap-4 text-lg">
