            ...
            {matchRoute !== undefined ? (
              ...
              <>
                ...
                <p className="text-[#8b9cc7] text-[.95rem] mb-6">
                  Junte-se a nós para explorar todos os nossos recursos e serviços
                </p>
                <FormRegister />
              </>
            )}
            ...
            <div className="absolute z-10 w-full h-full right-[-20%] flex items-center justify-center">
              ...
              >
                ...
                <g className="floating-icons">
                  <rect x="50" y="100" width="60" height="60" rx="15" fill="#2D6BE4" opacity="0.3">
                    <animate
                      attributeName="y"
                      values="100;90;100"
                      dur="3s"
                  ...
                  <rect x="450" y="300" width="40" height="40" rx="10" fill="#2D6BE4" opacity="0.3">
                    <animate
                      attributeName="y"
                      values="300;280;300"
                      dur="3.5s"
